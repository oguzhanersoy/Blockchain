...
def ComputeResults_wo_fee_selection(selectedNodes):
    ...
    k=1
    for K in selectedNodes:
        CreateChannel(graph_new,NoV-1,K,OurCapacity,def_base_fee,def_fee_rate,txValue)
        globalmaxRew=ComputeTotalGraphReward(graph_new)
        array1[k]=globalmaxRew
        k=k+1
...
#result_between_wo_fee=ComputeResults_wo_fee_selection(BNodes)
#np.save('HighTxData/result_between_wo_fee.npy',result_between_wo_fee)
...
#result_pagerank_wo_fee=ComputeResults_wo_fee_selection(PRNodes)
#np.save('HighTxData/result_pagerank_wo_fee.npy',result_pagerank_wo_fee)
...
#result_degree_wo_fee=ComputeResults_wo_fee_selection(DNodes)
#np.save('HighTxData/result_degree_wo_fee.npy',result_degree_wo_fee)
...
#
##RNodes_all_wo_fee=np.zeros([epochNum,T],dtype=np.int)
##result_random_all_wo_fee=np.zeros([epochNum,T+1],dtype=np.int)
#
...
##    RNodes_in_wo_fee=SelectKRandomNodes(graph_new,T+3)
##    RNodes_all_wo_fee[epoch]=SelectKDifferentNodes(RNodes_in_wo_fee,T)
##    print RNodes_all_wo_fee[epoch]
##    result_random_all_wo_fee[epoch]=ComputeResults_wo_fee_selection(RNodes_all_wo_fee[epoch])
#
#np.save('MidTxNew/result_random_all.npy',result_random_all)
#np.save('MidTxNew/RNodes_all.npy',RNodes_all)
##np.save('HighTxData/result_random_all_wo_fee.npy',result_random_all_wo_fee)
...
#globalmaxRew=ComputeTotalGraphReward(graph_new)
#
#GreedyNodes=[3265,1163,2565,3349,1508,2222,3884]
...
#epochNum=10
#result_between=np.load('HighTxData/result_between.npy')
#result_degree=np.load('HighTxData/result_degree.npy')
#result_pagerank=np.load('HighTxData/result_pagerank.npy')
#result_random_all=np.load('HighTxData/result_random_all.npy')
#result_selected=np.load('HighTxData/result_selected.npy')
#
...
#plt.figlegend(('Betweenness','Degree','Pagerank','Random','Selected'),loc='lower center',ncol=3,bbox_to_anchor=(0.5, 0.9))
#plt.savefig('Hightx_1000000_greedy_result_final.pdf')
#plt.xlabel('The number of new node connections')
#plt.ylabel('The total fee reward') 
#plt.xticks(np.arange(1, 21, step=1))
#


fig, (ax1, ax2) = plt.subplots(2, 1,sharex='col',sharey='row',gridspec_kw={'hspace': 0.15})
...
result_between_wo_fee=np.load('MidTxNew/result_between_wo_fee.npy')
result_degree_wo_fee=np.load('MidTxNew/result_degree_wo_fee.npy')
result_pagerank_wo_fee=np.load('MidTxNew/result_pagerank_wo_fee.npy')
result_random_all_wo_fee=np.load('MidTxNew/result_random_all_wo_fee.npy')
...
epochNum=10
result_random_wo_fee=np.zeros(len(result_random_all_wo_fee[0]))
for epoch in np.arange(epochNum):
    for ind in np.arange(len(result_random_all_wo_fee[0])):
        result_random_wo_fee[ind]=result_random_wo_fee[ind]+result_random_all_wo_fee[epoch][ind]/epochNum

t=np.arange(0,T+1)

#f2 = plt.figure(2)
ax1.plot(t,result_between[:], 'ro-',fillstyle='none')
ax1.plot(t,result_degree[:], 'bs-',fillstyle='none')
ax1.plot(t,result_pagerank[:], 'g^-',fillstyle='none')
ax1.plot(t,result_random[:], 'cd-',fillstyle='none')
ax1.plot(t,result_between_wo_fee[:], 'ro:', fillstyle='none')
ax1.plot(t,result_degree_wo_fee[:], 'bs:', fillstyle='none')
ax1.plot(t,result_pagerank_wo_fee[:], 'g^:', fillstyle='none')
ax1.plot(t,result_random_wo_fee[:], 'cd:', fillstyle='none')
ax1.plot(t[0:len(result_selected)],result_selected[:], 'mh-')

#ax1.set(ylabel='Medium graph')
#plt.figlegend(('Betweenness','Degree','Pagerank','Random','Selected'),loc='lower center',ncol=3,bbox_to_anchor=(0.5, 0.9))
#plt.savefig('Midtx_test.pdf')
#plt.xlabel('The number of new node connections')
#plt.ylabel('The total fee reward') 
#plt.xticks(np.arange(1, 21, step=1))


ax2.plot(t,result_between[:], 'ro-',fillstyle='none')
ax2.plot(t,result_degree[:], 'bs-',fillstyle='none')
ax2.plot(t,result_pagerank[:], 'g^-',fillstyle='none')
ax2.plot(t,result_random[:], 'cd-',fillstyle='none')
ax2.plot(t,result_between_wo_fee[:], 'ro:', fillstyle='none')
ax2.plot(t,result_degree_wo_fee[:], 'bs:', fillstyle='none')
ax2.plot(t,result_pagerank_wo_fee[:], 'g^:', fillstyle='none')
ax2.plot(t,result_random_wo_fee[:], 'cd:', fillstyle='none')
#ax2.plot(t[0:len(result_selected)],result_selected[:], 'mh-')



plt.figlegend(('Betweenness','Degree','Pagerank','Random','Betweenness w\o CFF','Degree w\o CFF','Pagerank w\o CFF','Random w\o CFF' ,'Greedy'),loc='lower center',ncol=3,bbox_to_anchor=(0.5, -0.0),fontsize='small')
...
plt.savefig('Medium.pdf',bbox_inches='tight')
...
result_random_all=np.load('HighTxData/result_random_all.npy')
result_selected=np.load('HighTxData/result_selected.npy')
result_between_wo_fee=np.load('HighTxData/result_between_wo_fee.npy')
result_degree_wo_fee=np.load('HighTxData/result_degree_wo_fee.npy')
result_pagerank_wo_fee=np.load('HighTxData/result_pagerank_wo_fee.npy')
result_random_all_wo_fee=np.load('HighTxData/result_random_all_wo_fee.npy')
...
ax2.plot(t,result_random_wo_fee[:], 'cd:', fillstyle='none')
#ax2.plot(t[0:len(result_selected)],result_selected[:], 'mh-')
#ax2.set(ylabel='Macro graph')


plt.figlegend(('Betweenness','Degree','Pagerank','Random','Betweenness w\o CFF','Degree w\o CFF','Pagerank w\o CFF','Random w\o CFF' ,'Greedy'),loc='lower center',ncol=3,bbox_to_anchor=(0.5, -0.0),fontsize='small')
#plt.figlegend(('Betweenness','Degree','Pagerank','Random','Betweenness w\o CFF','Degree w\o CFF','Pagerank w\o CFF','Random w\o CFF' ),loc='lower center',ncol=3,bbox_to_anchor=(0.5, -0.0),fontsize='small')
...
plt.savefig('Macro.pdf',bbox_inches='tight')

#plt.yticks([600000000,650000000,660000000,670000000,680000000, 690000000, 700000000, 800000000,1000000000,1200000000])
...
#t=np.arange(0,T+1)
#
#ax1.plot(t,result_between[:], 'ro-',t,result_degree[:], 'bs-',t,result_pagerank[:], 'g^-', t,result_random[:], 'cd-', t[0:len(result_selected)],result_selected[:], 'mh-')
#
#epochNum=1
#result_between=np.load('MidTxNew/result_between.npy')
#result_degree=np.load('MidTxNew/result_degree.npy')
...
#t=np.arange(0,T+1)
#
#ax2.plot(t,result_between[:], 'ro-',t,result_degree[:], 'bs-',t,result_pagerank[:], 'g^-', t,result_random[:], 'cd-', t[0:len(result_selected)],result_selected[:], 'mh-')
#
#plt.ylabel('The total fee reward') 
#plt.xlabel('The number of new node connections')
#plt.xticks(np.arange(1, 21, step=1))
