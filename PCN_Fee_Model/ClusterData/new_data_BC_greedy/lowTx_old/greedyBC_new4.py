...
def CostofTxCuttingEdges(graph,txAmount):
    ...
    for edge in copy_graph.es:
        if edge['capacity'] >= txAmount:
            edge['txCost']=int(edge['base_fee']*1+(edge['fee_rate']*txAmount)/1000 )
        else:
            copy_graph.delete_edges(edge)
...
# mid_graph_new=copy.deepcopy(loaded_graph)
# CostofTx(mid_graph_new,1000)
# Graph.save(mid_graph_new,'midgraphw2con_new.txt',format='pickle')
...
# CreateChannel(graph_new,NoV-1,1988,OurCapacity,our_base_fee,our_fee_rate,txValue)
# CreateChannel(graph_new,NoV-1,646,OurCapacity,our_base_fee,our_fee_rate,txValue)
# CreateChannel(graph_new,NoV-1,2461,OurCapacity,our_base_fee,our_fee_rate,txValue)

CreateChannel(graph_new,NoV-1,498,OurCapacity,our_base_fee,our_fee_rate,txValue)
CreateChannel(graph_new,NoV-1,3265,OurCapacity,our_base_fee,our_fee_rate,txValue)
CreateChannel(graph_new,NoV-1,3884,OurCapacity,our_base_fee,our_fee_rate,txValue)
